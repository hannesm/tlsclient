...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6332f27f8836578507bb278714a82ef3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/hannesm/tlsclient";
          synopsis = "TLS client";
          description = Some [OASISText.Para "Secure tunnel"];
          categories = [];
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("./_build/src/tlsclient.native",
                           ["--help"; ">"; "./_build/src/tlsclient.1"])))
                 ]
            };
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "tlsclient.ml"})
            ];
          plugins =
     ...
     oasis_version = "0.4.5";
     oasis_digest =
       Some "\235\017\001~\134\131\204\217\175\245D\174\012\159~\148";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
